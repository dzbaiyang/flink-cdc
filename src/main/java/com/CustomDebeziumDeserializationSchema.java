...
/**
 * @author 柏洋
 * @date: 2022/03/05 10:31
 * @description: 自定义的DebeziumDeserializationSchema, mysql-binglog转化为期待的数据类型
 */

public class CustomDebeziumDeserializationSchema implements DebeziumDeserializationSchema<JSONObject>, com.ververica.cdc.debezium.DebeziumDeserializationSchema<JSONObject> {
